        ...
        <section ref={ refs.home.homeRef } className={`${colorState === 'dark' ? 'dark' : 'light'} rs-banner__section`}>
            <div className="m-auto container-none">
                <div className="columns-1 flex justify-end">
                    ...
                    <div className='w-full md:w-[calc(100%_-_6rem)] relative rounded-t-none md:rounded-t-3xl rounded-3xl overflow-hidden '>
                        ...
                        <div className='container m-auto rs-banner__main-banner py-28 z-1 relative'>
                            <div className="rs-banner__content px-4 py-10 md:px-16 md:py-20 bg-white-600 bg-opacity-70 backdrop-blur-md rounded-3xl max-w-3xl dark:bg-black-500 dark:bg-opacity-25">

                ...
                <div className='flex flex-col md:flex-row'>
                    <div className='w-full md:w-1/12'>
                        <div className='rs-exp__headline h-full relative mb-6 md:mb-0'>
                            <h2 className={`${proza.className} text-6xl xs:text-7xl font-[400] md:whitespace-nowrap text-secondary md:-rotate-90 md:-translate-x-1/2 md:-translate-y-1/2 md:absolute md:left-1/2 md:top-1/2 md:tracking-wider dark:text-white-400`}>Rikesh Shrestha</h2>
                        </div>
                    </div>

                    ...
                    <div className="rs-exp__wrapper">
                        ...
                        <div className='rs-exp__work-skills'>
                            ...
                            <ul>
                                ...
                                <li><img src={sass} alt="..."></img></li>
                                <li><img src={javascript} alt="..."></img></li>
                                <li><img src={react} alt="..."></img></li>
                                <li><img src={angular} alt="..."></img></li>
                                <li><img src={vue} alt="..."></img></li>
                                <li><img src={mongodb} alt="..."></img></li>
                                <li><img src={mysql} alt="..."></img></li>
                                <li><img src={node} alt="..."></img></li>
                                <li><img src={firebaseIcon} alt="..."></img></li>
                                <li><img src={express} alt="..."></img></li>
                                <li><img src={figma} alt="..."></img></li>
                                <li><img src={xd} alt="..."></img></li>
                                <li><img src={zeplin} alt="..."></img></li>
                                <li><img src={git} alt="..."></img></li>
                                <li><img src={github} alt="..."></img></li>
                                <li><img src={bitbucket} alt="..."></img></li>
                                <li><img src={jira} alt="..."></img></li>
                                <li><img src={netlify} alt="..."></img></li>
                                <li><img src={heroku} alt="..."></img></li>
                                <li><img src={vscode} alt="..."></img></li>
                            </ul>
                        </div>
                    </div>
                </div>
